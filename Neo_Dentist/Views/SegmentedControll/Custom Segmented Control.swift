...
final class CustomSegmetedControl: UIView {
    ...
    convenience init(buttonTitles: [String], 
                     ...
                     fontSelected: UIFont = .preferredFont(forTextStyle: .body, compatibleWith: .init(legibilityWeight: .bold)),
    ...
    private func prepareButtons() {
        buttons = buttonTitles.map { title in
            ...
            button.setTitleColor(tintColor.withAlphaComponent(0.5), for: .normal)
